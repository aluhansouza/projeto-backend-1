package api.integrationtests.controller.withyaml.mapper;
...
public class YAMLMapper implements ObjectMapper {
    ...
    public YAMLMapper() {
        mapper = new com.fasterxml.jackson.databind.ObjectMapper(new YAMLFactory()).disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
